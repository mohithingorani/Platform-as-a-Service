  ...
  return (
    <div className="h-screen px-6 md:px-0 bg-[url('/background-auth.webp')] bg-cover w-full flex justify-center items-center">
      ...
      <div className="flex flex-col gap-1 justify-center items-center ">
        ...
        <input
          type="text"
          className="px-4 mb-2 text-sm outline-none backdrop-filter  backdrop-blur-sm py-2 w-full  bg-white bg-opacity-20 border rounded-xl border-white border-opacity-30"
        />
...
function SignInButton({
 ...
 gap-1 md:gap-3 px-3 py-4 md:px-6 md:py md:py-3 bg-white hover:bg-opacity-100 transition duration-300  rounded-xl  border-opacity-30"
      >
        <Image
